import "../../styles/pages/auth-pages/AuthPage.css";
...
import showPasswordImg from "../../assets/forms/password-eye.png";
import hidePasswordImg from "../../assets/forms/hidden-password-eye.png";
